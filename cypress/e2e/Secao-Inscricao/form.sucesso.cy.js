describe('Preenchimento do formulário de inscrição', () => {
  ...
  it('Deve preencher o formulário com nome válido', () => {
    ...
    cy.get('input[name="pessoa.telefonePrincipal"]').should('not.be.disabled').type('61944237856')
    cy.get('input[name="pessoa.emailPrincipal"]').should('not.be.disabled').type('carol112@gmail.com')
  })
