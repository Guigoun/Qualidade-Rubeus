describe('Preenchimento do formulário de inscrição', () => {
  ...
  it('Deve preencher o formulário com nome válido', () => {
    ...
    cy.get('input[name="pessoa.nome"]').should('be.visible').type('FHODIF~323RF-2-934293FWEDJ')
    cy.get('input[name="pessoa.telefonePrincipal"]').should('not.be.disabled').type('12382174071302389840911089812098092')
    cy.get('input[name="pessoa.emailPrincipal"]').should('not.be.disabled').type('vajdq3kn1çrfsjaai9@@fa0ai0')
